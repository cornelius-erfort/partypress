...
packages <- c(
  "quanteda", "quanteda.textmodels", "dplyr", "caret", "randomForest", "tm", "rmarkdown", "plyr", "readr", "ggplot2", "stringr", "formatR", "readstata13", "lubridate", "reticulate", "doMC", "glmnet", "randomForest", "adabag", "kableExtra", "stargazer")
...
tm_eval[order(tm_eval$accuracy, decreasing = T), c("model", "accuracy", "precision", "recall", "f1_score")] %>% 
  %>% dplyr::rename(Model = model, Accuracy = accuracy, Precision = precision, )
  stargazer(out = "tables/tm_eval.tex", summary = F)
