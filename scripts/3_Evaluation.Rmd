...
party_eval <- party_perf %>% dplyr::group_by(country, parlgov_id, party_name) %>% dplyr::summarise(accuracy = quanteda.classifiers::accuracy(prediction, issue, by_class = F) %>% unlist,
                                                                                       precision =  quanteda.classifiers::precision(prediction, issue, by_class = F, na.rm = T),
                                                                                       recall =  quanteda.classifiers::recall(prediction, issue, by_class = F),
                                                                                       f1 =  quanteda.classifiers::f1_score(prediction, issue, by_class = F))
