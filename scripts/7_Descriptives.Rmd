...
# issue_agendas$attention <- issue_agendas$attention * 100
# Imm
for (this_country in unique(issue_agendas$country_name) %>% sort) {

  plot_data <- filter(issue_agendas, country_name == this_country & issue_multi == 9)
