...
spec_att$time[spec_att$date >= ymd("2018-01-01") & spec_att$date <= ymd("2018-12-31") & spec_att$issue_r1 == 7] <- "2018" 
spec_att$time[spec_att$date >= ymd("2017-01-01") & spec_att$date <= ymd("2017-12-31") & spec_att$issue_r1 == 7] <- "2017" 
